...
local function get_jdtls_paths()
  ...
  path.runtimes = {
    ...
    {
      name = 'JavaSE-1.8',
      path = vim.fn.expand '~/.sdkman/candidates/java/8.0.402-zulu',
    },
    {
      name = 'JavaSE-11',
      path = vim.fn.expand '~/.sdkman/candidates/java/11.0.21-amzn',
    },
    {
      name = 'JavaSE-17',
    ...
    {
      name = 'JavaSE-21',
      path = vim.fn.expand '~/.sdkman/candidates/java/21.0.1-amzn',
    },
  }
